...
# ---------------------------------------------------- SCRIPT ARGS -----------------------------------------------------
parser = argparse.ArgumentParser (description     = "Runs a nihao run.",
                                  formatter_class = argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("-s", "--nspe", default = 2,
                    help = "Number of SPE free params.")
parser.add_argument("-c", "--nclass", default = 1,
                    help = "Number of CLASS free params.")
parser.add_argument("-b", "--bary", default = "hydro",
                    help = "Baryonic or DMO: 'hydro' or 'dmo'.")
...
parser.add_argument("-bs", "--batch_size", default = 2000,
                    help = "Batch size.")
...
N_EPOCHS          = int(1e99) # 1 # int(1e99)  #int(1e99) # tmp 1 #
